...
class XmlComicInfo {
  /// Title of the book.
  @xml_annotation.XmlElement(name: 'Title')
  final String? title;

  /// Title of the series the book is part of.
  @xml_annotation.XmlElement(name: 'Series')
  final String? series;

  /// Number of the book in the series.
  @xml_annotation.XmlElement(name: 'Number')
  final String? number;
  ...
  @xml_annotation.XmlElement(name: 'Count')
  final int? count;
  ...
  @xml_annotation.XmlElement(name: 'Volume')
  final int? volume;
  ...
  @xml_annotation.XmlElement(name: 'AlternateSeries')
  final String? alternateSeries;

  @xml_annotation.XmlElement(name: 'AlternateNumber')
  final String? alternateNumber;

  @xml_annotation.XmlElement(name: 'AlternateCount')
  final int? alternateCount;

  /// A description or summary of the book.
  @xml_annotation.XmlElement(name: 'Summary')
  final String? summary;

  /// A free text field, usually used to store information about the application that created the ComicInfo.xml file.
  @xml_annotation.XmlElement(name: 'Notes')
  final String? notes;

  /// Usually contains the release date of the book.
  @xml_annotation.XmlElement(name: 'Year')
  final int? year;
  @xml_annotation.XmlElement(name: 'Month')
  final int? month;
  @xml_annotation.XmlElement(name: 'Day')
  final int? day;
  ...
  @xml_annotation.XmlElement(name: 'Translator')
  ...
  @xml_annotation.XmlElement(name: 'Imprint')
  ...
  @xml_annotation.XmlElement(name: 'Genre')
  final String? genre;

  /// Tags of the book or series. For example, ninja or school life.
  /// It is accepted that multiple values are comma separated.
  @xml_annotation.XmlElement(name: 'Tags')
  final String? tags;
  ...
  @xml_annotation.XmlElement(name: 'Web')
  final String? web;

  /// The number of pages in the book.
  @xml_annotation.XmlElement(name: 'PageCount')
  final int? pageCount;
  ...
  @xml_annotation.XmlElement(name: 'LanguageISO')
  ...
  @xml_annotation.XmlElement(name: 'Format')
  final String? format;

  /// Whether the book is in black and white.
  @xml_annotation.XmlElement(name: 'BlackAndWhite')
  ...
  @xml_annotation.XmlElement(name: 'StoryArc')
